...
# 调用方法
# UPDATE_PACKAGE "包名" "项目地址" "项目分支" "pkg/name，可选，pkg为从大杂烩中单独提取包名插件；name为重命名为包名" "自定义删除名称列表"
...
UPDATE_PACKAGE "OpenWrt-Packages" "chenxin527/OpenWrt-Packages" "main" "" "luci-app-filemanager"
